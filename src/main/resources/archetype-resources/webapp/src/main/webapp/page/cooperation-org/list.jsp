...
<div class="easyui-layout" fit="true">
	<div data-options="region:'north',title:'单位列表',split:true" style="height: 400px;">
		...
		<table id="organization_dategrid" >
			<thead>
				<tr>
					...
					<th data-options="field:'homePage'" width="130">主页</th>
					<th data-options="field:'tel'" width="90">电话</th>
					<th data-options="field:'email'" width="90">电子邮箱</th>
		...
		<shiro:hasPermission name="supervisorOrganization:edit">
			<div id="organization_add_dialog" title="添加"
				...
				<form id="organization_add_form" method="post"
					action="${symbol_dollar}{basePath}/cooperation-org/add.action">
		...
		<script type="text/javascript">
            ...
            ${symbol_dollar}(function(){
                ...
                ${symbol_dollar}('${symbol_pound}organization_dategrid').datagrid({
                    url:"${symbol_dollar}{basePath}/cooperation-org/list-json.action",
                    fit: true,
                    rownumbers: true,
                    singleSelect: true,
                    fitColumns:true,
                    ...
                    onClickRow :function (rowIndex, rowData){
                        var id = rowData.id;
                        ${symbol_dollar}('${symbol_pound}organization_person_dategrid').datagrid({'url':'${symbol_dollar}{basePath}/cooperation-org/list-people-json.action?id=' + id});
                    }
                    <shiro:hasPermission name="supervisorOrganization:edit">
                    ,
                    toolbar: [
                        ...
                        },
                        {
                        	...
                        	handler : function(){
                        		...
                        		var url = '${symbol_dollar}{basePath}/cooperation-org/destory.action?id=' + id;
	...
	<div data-options="region:'center',title:'单位联系人'"
		style="padding: 5px; background: ${symbol_pound}eee;">

		<table id="organization_person_dategrid"
			class="easyui-datagrid" fit="true" singleSelect="true" pageSize="20"
			pagination="true"
		...
		<shiro:hasPermission name="exterOrgPerson:edit">
			<div id="organization_contract_add_dialog"
				class="easyui-dialog" title="添加联系人" closed="true"
				style="width: 320px; height: 400px; padding: 10px 0 0 10px;">
				<form id="organization_person_add_form"
					action="${symbol_dollar}{basePath}/cooperation-org/add-person.action" method="post">
					<p>
					...
					<hr />
					<input id="org_list_add_person_form_orgid" type="hidden"
						name="id" />
					<button type="submit">确定</button>
				</form>
			...
			<script type="text/javascript">
                ...
                function organization_contract_remove_handler(){
                    ...
                    if(row){
                        ...
                        getJSON('${symbol_dollar}{basePath}/cooperation-org/remove-person.action?id=' + row.id + '&orgId=' + org_id);
