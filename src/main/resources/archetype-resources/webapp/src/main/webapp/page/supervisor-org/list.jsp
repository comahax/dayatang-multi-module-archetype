		...
		<shiro:hasPermission name="supervisorOrganization:edit">
			<div id="organization_add_dialog" title="添加"
				...
				<form id="organization_add_form" method="post"
					action="${symbol_dollar}{basePath}/supervisor-org/add.action">
		...
		<script type="text/javascript">
            ...
            ${symbol_dollar}(function(){
                ...
                ${symbol_dollar}('${symbol_pound}organization_dategrid').datagrid({
                    url:"${symbol_dollar}{basePath}/supervisor-org/list-json.action",
                    fit: true,
                    fitColumns:true,
                    rownumbers: true,
                    singleSelect: true,
                    ...
                    onClickRow :function (rowIndex, rowData){
                        var id = rowData.id;
                        ${symbol_dollar}('${symbol_pound}organization_person_dategrid').datagrid({'url':'${symbol_dollar}{basePath}/supervisor-org/list-people-json.action?id=' + id});
                    }
<shiro:hasPermission name="supervisorOrganization:edit">
,
                    toolbar: [
                        ...
                        },
                        {
                        	...
                        	handler:function(){
                        		...
                        		var url = '${symbol_dollar}{basePath}/supervisor-org/destory.action?id=' + id;
		...
		<shiro:hasPermission name="exterOrgPerson:edit">
			<div id="organization_contract_add_dialog"
				...
				<form id="organization_person_add_form"
					action="${symbol_dollar}{basePath}/supervisor-org/add-person.action" method="post">
					<p>
            ...
            function organization_contract_remove_handler(){
                ...
                if(row){
                    ...
                    getJSON('${symbol_dollar}{basePath}/supervisor-org/remove-person.action?id=' + row.id + '&orgId=' + org_id);
                    imessager.success_tip();
