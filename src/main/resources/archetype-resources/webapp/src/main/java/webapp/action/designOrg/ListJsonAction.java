...
public class ListJsonAction extends BaseAction {
	...
	private static final long serialVersionUID = 6324846272231425264L;
    ...
    public String execute() throws Exception {
        ...
        PageList<DesignOrganization> pageList = createPageList(DesignOrganization.findAll(DesignOrganization.class));
